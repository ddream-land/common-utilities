...
function AlterMessages({ messages, isOpen = false, onClose }: AlterMessagesProps) {
                    ...
                    <div className="grow shrink basis-0 flex-col justify-start items-start gap-2 inline-flex">
                      <div className="self-stretch justify-start items-start gap-2 inline-flex">
                        <div className="grow shrink basis-0 flex-col justify-start items-start gap-1 inline-flex">
                          {msg.title && (
                            <div className="text-white text-base font-medium leading-normal">{msg.title}</div>
                          )}
                          <div className="pt-1 self-stretch text-white text-sm font-normal leading-tight">
                            {msg.message}
                          </div>
                        </div>
