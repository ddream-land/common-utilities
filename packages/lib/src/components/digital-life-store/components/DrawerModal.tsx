...
function DrawerModal({ children, modalDisclosure }: { children: ReactNode; modalDisclosure: TypeModalDisclosure }) {
  return (
    <Modal
      size="full"
      ...
      classNames={{
        ...
        body: "bg-zinc-900 rounded-tl-2xl rounded-tr-2xl px-[120px] border-[#898989] border-t border-solid items-center",
        footer: "bg-zinc-900 rounded-bl-xl rounded-br-xl px-[120px]",
      }}
      closeButton={
        <div>
          <XMarkIcon className="w-10 h-10 fill-zinc-400" />
        </div>
      }
