...
import nuwaIconBase64 from "../../image/NuwaIcon";
      ...
      <div className="w-full h-full flex flex-col justify-between">
        <div className="w-full flex flex-col gap-5">
          <div className="w-full flex flex-row justify-center items-center gap-2">
            <Image disableSkeleton={true} width={37} height={50} src={nuwaIconBase64} alt="icon" />
            <Image disableSkeleton={true} width={149} height={50} src={nuwaLogoBase64} alt="logo" />
          </div>
