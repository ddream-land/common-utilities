...
function StylePreferenceModal({
  ...
  const handleInsertPersonality = () => {
    ...
    let personalityStr = keys + newPersonalityStrAr;
    onChange(personalityStr);
    spModal.onClose();
  };
    ...
    <div className="flex flex-col">
      <Modal
        ...
        classNames={{
          ...
          body: "bg-transparent h-full w-full p-0",
          backdrop: "h-full",
              ...
              <div className="grid grid-cols-7 gap-4 h-full w-full relative">
                ...
                <div className="col-span-3 h-full overflow-hidden">
                  <StylePreferenceOcAi
                    personalityDataList={personalityDataList}
                    handleFruitClick={handleFruitClick}
                    handleInsertPersonality={handleInsertPersonality}
                  />
                </div>
              </div>
            </ModalBody>
      ...
      <StylePreferenceCustomerModal personalityDataList={personalityDataList} isOpen={plistModalIsOpen} name={pListName} index={pListIndex} usePersonalityDataList={usePersonalityDataList} onClose={() => {
        usePListName("");
        usePListIndex(-1);
